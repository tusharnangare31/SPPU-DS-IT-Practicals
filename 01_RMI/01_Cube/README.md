# Implement Multi-threaded Client/Server Process Communication Using RMI to Find Cube of a Given Number

---

# AIM

To implement multi-threaded client/server process communication using Java RMI (Remote Method Invocation) to calculate the cube of a given number.
...
- To calculate the cube of a number using remote method invocation.
...
The multi-threaded client/server communication using Java RMI to calculate the cube of a given number was successfully implemented and executed.

---

# CONCLUSION

The Java RMI application successfully demonstrated remote communication between client and server processes. The client remotely invoked the cube method from the server and received the computed result correctly.
