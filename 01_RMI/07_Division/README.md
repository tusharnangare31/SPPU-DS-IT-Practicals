# Implement Multi-threaded Client/Server Process Communication Using RMI to Find Division of Given Numbers

---

# AIM

To implement multi-threaded client/server process communication using Java RMI (Remote Method Invocation) to calculate the division of given numbers.
...
- To perform division using remote method invocation.
...
2. Declare remote method `divide()`.
...
6. Accept two numbers from user.
7. Invoke remote method.
8. Display division of numbers.
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Division: " + serverIntf.divide(num1, num2));
...
First Number is 20.0
Second Number is 5.0
Division: 4.0
```
...
First Number is 100.0
Second Number is 25.0
Division: 4.0
```
...
The multi-threaded client/server communication using Java RMI to calculate the division of given numbers was successfully implemented and executed.

---

# CONCLUSION

The Java RMI application successfully demonstrated remote communication between client and server processes. The client remotely invoked the division method from the server and received the computed result correctly.
