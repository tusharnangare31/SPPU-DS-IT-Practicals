# Implement Multi-threaded Client/Server Process Communication Using RMI to Find Square Root of a Given Number

---

# AIM

To implement multi-threaded client/server process communication using Java RMI (Remote Method Invocation) to calculate the square root of a given number.
...
- To calculate the square root of a number using remote method invocation.
...
8. Display square root of number.
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Square Root: " + serverIntf.sqrt(num));
...
The multi-threaded client/server communication using Java RMI to calculate the square root of a given number was successfully implemented and executed.

---

# CONCLUSION

The Java RMI application successfully demonstrated remote communication between client and server processes. The client remotely invoked the square root method from the server and received the computed result correctly.
