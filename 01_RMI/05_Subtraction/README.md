# Implement Multi-threaded Client/Server Process Communication Using RMI to Find Subtraction of Given Numbers

---

# AIM

To implement multi-threaded client/server process communication using Java RMI (Remote Method Invocation) to calculate the subtraction of given numbers.
...
- To perform subtraction using remote method invocation.
...
2. Declare remote method `subtract()`.
...
8. Display subtraction of numbers.
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Subtraction: " + serverIntf.subtract(num1, num2));
...
The multi-threaded client/server communication using Java RMI to calculate the subtraction of given numbers was successfully implemented and executed.

---

# CONCLUSION

The Java RMI application successfully demonstrated remote communication between client and server processes. The client remotely invoked the subtraction method from the server and received the computed result correctly.
